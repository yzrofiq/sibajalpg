...
<head>
    ...
    <style>
        ...
        h3 { text-align: center; margin-bottom: 16px; font-size: 14px; }
        ...
        th:nth-child(12), td:nth-child(12) { width: 10%; text-align: right; }
    ...
    <tbody>
        ...
        @forelse($data as $i => $row)
            ...
            <tr>
                ...
                <td>{{ number_format($row['total_nilai_swakelola'], 0, ',', '.') }}</td>
