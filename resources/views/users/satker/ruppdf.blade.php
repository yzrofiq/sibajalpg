<style>
    ...
    table {
        ...
        width: 100%;
        margin-bottom: 10px;
        table-layout: fixed; /* Menetapkan lebar kolom yang lebih pasti */
    }
    td, th {
        word-wrap: break-word;
        text-align: right; /* Menyesuaikan alignment kolom */
    }
    /* Menambah lebar kolom agar lebih pas */
    ...
    td:nth-child(7), td:nth-child(8), td:nth-child(9), td:nth-child(10) {
        width: 10%; /* Lebar kolom untuk setiap kolom data */
    }
