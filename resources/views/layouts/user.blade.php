...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm sticky-top">
  ...
  <li class="nav-item"><a class="nav-link" href="{{ route('tender.list') }}">Tender</a></li>
  <li class="nav-item"><a class="nav-link" href="{{ route('non-tender.list') }}">Non Tender</a></li>

  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">E-Purchasing</a>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="{{ route('report.ekatalog') }}">E-Katalog</a></li>
      <li><a class="dropdown-item" href="{{ route('tender.fund.source') }}" target="_blank">Toko Daring</a></li>
    </ul>
  </li>

  <li class="nav-item"><a class="nav-link" href="{{ route('report.rup') }}">RUP</a></li>

  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Monitoring</a>
    <ul class="dropdown-menu">
      {{-- Tidak ada menu Monitoring di sidebar, jadi dikosongkan --}}
    </ul>
  </li>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="{{ route('vendor.list') }}">Data Vendor</a></li>
    <li><a class="dropdown-item" href="{{ route('report.review') }}" target="_blank">Hasil Review</a></li>
  </ul>
</li>


  <li class="nav-item"><a class="nav-link" href="{{ route('report') }}" target="_blank">Grafik Report</a></li>
</ul>
...
<footer class="text-center p-2 mt-0" style="background-color: #2b3e64; color: white;">
    <p class="mb-0">© {{ date('Y') }} Pemerintah Provinsi Lampung – Biro Pengadaan Barang dan Jasa</p>
</footer>
